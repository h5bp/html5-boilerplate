...
https://github.com/Lucasvieiragarcia/html5-boilerplate
snapshot inicial v0.1

3. Descrição
Evoluir um site simples baseado no HTML5 Boilerplate, adicionando páginas e seções novas, personalização visual e pequenos recursos interativos, para consolidar práticas de Versionamento com Git: issues, branches, PRs, reviews, tags
confrome solicitado. O objetivo é criar uma landing page funcional, com layout responsivo, informações organizadas e navegação básica.
