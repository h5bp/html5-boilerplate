...
We are actively looking for new open-source projects to join the organization. This document outlines some requriements for inclusion.  
...
2. **Co-Maintenance Intent:** H5BP acts as an active repository steward, not an archive for abandoned code. Original authors must commit to co-maintaining the project or, under certain cicumstances, provide comprehensive documentation for a structured transition.
...
* **Architectural Discipline:** Code must be structured for long-term maintenance. Clean modularity, strict typing standards (TypeScript prefered), and comprehensive automated test suites are highly valued. Real, useful documentation is required. We educate as much as we provide features and functionality.
