...
The `<title>` tag is required and defines the title of the page. The title
will be displayed within the browser and in search engine results.
...
The `description` meta tag gives search engines a description of what your page is about.
Most search engines such as Google and Bing will display the text defined in
this tag beneath the page's title in their results.

```html
<meta name="description" content="This is a description">
```

Additional useful meta tags can be found in the [Extend](extend.md) doc.
