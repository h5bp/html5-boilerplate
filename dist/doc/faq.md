...
the Google [CDN](http://searchaws.techtarget.com/definition/content-delivery-network-CDN) points to
is [no longer updated and will stay locked at version `1.11.1` in order to prevent inadvertent web
