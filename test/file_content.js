...
function runTests() {
    ...
    [].concat(
        ...
        describe('Test if the base files from "' + dir + '" have the expected content', function () {
    ...
    describe('Test if the build specific files from "' + dirs.dist.apache + '" have the expected content', function () {
        it('".htaccess" should have the "ErrorDocument..." line uncommented', function (done) {
            var string = '\n\nErrorDocument 404 /404.html\n\n';
            checkString(path.resolve(dirs.dist.apache, '.htaccess'), string, done);
        });
    });
